...
import { AcuteChronicComponent } from '../AcuteChronic';

describe('AcuteChronicComponent', () => {
  const props = {
    onChange: jest.fn(),
    t: (key) => key, // i18n stub
  };

  it('returns correct acute and chronic days', async () => {
    render(<AcuteChronicComponent {...props} />);
  ...
  it('prepopulates acute and chronic fields if values provided', () => {
    render(
      <AcuteChronicComponent
        {...props}
        firstPeriodLength={3}
