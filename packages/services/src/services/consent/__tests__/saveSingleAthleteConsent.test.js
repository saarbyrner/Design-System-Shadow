...
import saveSingleAthleteConsent, {
  endpoint,
} from '@kitman/services/src/services/consent/saveSingleAthleteConsent';
...
describe('searchConsentAthletes', () => {
  ...
  it('calls the correct endpoint and returns the correct value', async () => {
    const returnedData = await saveSingleAthleteConsent(payload);
  ...
  describe('Mock axios', () => {
    it('calls the correct endpoint with correct body data in the request', async () => {
      await saveSingleAthleteConsent(payload);
