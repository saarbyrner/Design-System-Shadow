...
import { mockedExportResponse } from '@kitman/services/src/mocks/handlers/exports/exportTimeLossAllActivitiesReport';

import exportTimeLossAllActivitiesReport from '../exportTimeLossAllActivitiesReport';

describe('exportTimeLossAllActivitiesReport', () => {
  let request;
  ...
  it('returns the correct csv value', async () => {
    const returnedData = await exportTimeLossAllActivitiesReport(
      issueTypes,
      population,
      columns,
      filters,
      'csv',
      true // includeDemographics
    );
  ...
  describe('Mock axios', () => {
    ...
    it('calls the correct endpoint with correct body data in the request for csv', async () => {
      await exportTimeLossAllActivitiesReport(
        issueTypes,
        population,
        columns,
        filters,
        'csv',
        true, // Include past players: yes
