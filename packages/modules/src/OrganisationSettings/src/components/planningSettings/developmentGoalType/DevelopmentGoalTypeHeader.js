...
const DevelopmentGoalTypeHeader = (props: I18nProps<Props>) => {
  ...
  const onClickFirstAction = () => {
    if (isPresentationView) {
      TrackEvent('Org Settings Planning', 'Create', 'Development goal type');
      props.onAddNew();
      return;
    }
...
export const DevelopmentGoalTypeHeaderTranslated: ComponentType<Props> =
  withNamespaces()(DevelopmentGoalTypeHeader);
export default DevelopmentGoalTypeHeader;
