...
import DevelopmentGoalTypeHeader from '../../developmentGoalType/DevelopmentGoalTypeHeader';

describe('<DevelopmentGoalTypeHeader />', () => {
  let baseProps;
  ...
  it('displays the correct title', () => {
    render(<DevelopmentGoalTypeHeader {...baseProps} />);
    expect(screen.getByText('Development goal type')).toBeInTheDocument();
  });

  describe('when view is PRESENTATION', () => {
    beforeEach(() => {
      render(<DevelopmentGoalTypeHeader {...baseProps} view="PRESENTATION" />);
    });
  ...
  describe('when view is EDIT', () => {
    beforeEach(() => {
      render(<DevelopmentGoalTypeHeader {...baseProps} view="EDIT" />);
    });
    ...
    it('enables the "Save" button when isSavingAllowed is true', () => {
      ...
      render(
        <DevelopmentGoalTypeHeader {...baseProps} view="EDIT" isSavingAllowed />
      );
