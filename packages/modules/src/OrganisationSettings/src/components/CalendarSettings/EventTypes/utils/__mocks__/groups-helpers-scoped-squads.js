...
export const expectedUpdatedEvents = [
  {
    ...
    children: undefined,
    name: parent1NewName,
    squads: clonedOriginalFormData[0].squads,
    colour: '',
  },
  {
    ...clonedOriginalFormData[0].children[0],
    name: parent1Child1NewName,
    squads: clonedOriginalFormData[0].children[0].squads,
  },
  {
    ...originalUngroupedChild,
    name: ungrouped1NewName,
    squads: ungrouped1NewSquads,
  },
];
...
export const responseEvent = {
  ...parent1,
  id: +parent1Id,
  squads: [{ id: squads[0], name: 'someName' }],
};
