...
describe('<Header />', () => {
  ...
  describe('[permissions] permissions.medical.issues.canEdit', () => {
    ...
    it('disables the buttons when view type is PRESENTATION and a request is pending', () => {
      renderTestComponent(undefined, undefined, {
        viewType: 'PRESENTATION',
    ...
    it('disables the buttons when view type is EDIT and a request is pending', () => {
      renderTestComponent(undefined, undefined, {
        viewType: 'EDIT',
        isRequestPending: true,
      });
    ...
    it('hides the edit button when the user is not an issue admin', async () => {
      renderTestComponent(undefined, undefined, {
        isIssuesAdmin: false,
      });
  ...
  describe('[editable-chronic-conditions] feature flag', () => {
    ...
    describe('when feature flag is on', () => {
      ...
      it('shows the edit button when view type is EDIT', async () => {
        renderTestComponent(
          undefined,
          {
            issue: {
