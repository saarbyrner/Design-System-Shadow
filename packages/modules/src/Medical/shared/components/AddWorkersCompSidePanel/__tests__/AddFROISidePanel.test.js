...
import AddFROISidePanel from '../AddFROISidePanel';
...
describe('<AddFROISidePanel />', () => {
  ...
  it('should render <AddFROISidePanel />', () => {
    const { container } = render(
      <Provider store={mockStore}>
        <AddFROISidePanel {...props} />
      </Provider>
    );
    ...
    expect(titleSpan).toHaveTextContent('First Report of Injury (FROI)');
  });
  ...
  describe('<AppStatus />', () => {
    ...
    it('should render <AppStatus /> error component if staff user request fails', async () => {
      render(
        <Provider store={mockStore}>
          <AddFROISidePanel {...props} staffUsersRequestStatus="FAILURE" />
        </Provider>
      );
    ...
    it('should render <AppStatus /> loading component if staff user request is pending', async () => {
      render(
        <Provider store={mockStore}>
          <AddFROISidePanel {...props} staffUsersRequestStatus="PENDING" />
        </Provider>
      );
  ...
  describe('auto population of person name value', () => {
    ...
    it('should use value from workers comp issue, if exists', async () => {
      ...
      render(
        <Provider store={mockStore}>
          <MockedIssueContextProvider issueContext={mockedIssueContextValue}>
            <AddFROISidePanel {...props} isOpen staffUsers={mockedStaffUsers} />
          </MockedIssueContextProvider>
        </Provider>
      );
