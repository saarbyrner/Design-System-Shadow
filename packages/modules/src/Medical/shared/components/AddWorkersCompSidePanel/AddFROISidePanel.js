...
const AddFROISidePanel = (props: I18nProps<Props>) => {
  ...
  return (
    <div data-testid="AddWorkersCompSidePanel__container">
      <SlidingPanelResponsive
        isOpen={props.isOpen}
        title={props.t('First Report of Injury (FROI)')}
...
export const AddFROISidePanelTranslated = withNamespaces()(AddFROISidePanel);
export default AddFROISidePanel;
