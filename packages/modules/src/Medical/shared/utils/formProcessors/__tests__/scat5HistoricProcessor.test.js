...
} from './mocks/scat5HistoricMock';

describe('concussionAssessmentProcessor scat5 historic', () => {
  ...
  describe('when the concussion-web-show-sac flag is off', () => {
    ...
    it('correctly processes a Concussion Assessment form', () => {
      ...
      expect(formattedFormResults).toHaveLength(12);
  ...
  describe('when the concussion-web-show-sac flag is on', () => {
    ...
    it('correctly processes a Concussion Assessment form', () => {
      ...
      expect(formattedFormResults).toHaveLength(13);
