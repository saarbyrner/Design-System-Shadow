...
import style from '@kitman/modules/src/Medical/procedures/src/components/AppHeader/styles';
...
const AppHeader = (props: I18nProps<Props>) => {
  ...
  return (
    <header css={style.header} data-testid="Procedures|Header">
      ...
      <section css={style.athleteSection}>
        ...
        <div css={style.athleteContent}>
          <div css={style.athleteNameWrapper}>
            ...
            >{`${props.athleteData.fullname} - ${props.procedureType}`}</h2>
