...
const TabAthleteDiscipline = (props: TabProps<DisciplineSearchParams>) => {
  ...
  >({
    useSearchQuery: useSearchDisciplineAthleteListQuery,
    initialFilters,
    onTransformData: transformToAthleteDisciplineRows,
...
export default TabAthleteDiscipline;
